...
# -*- encoding: utf-8 -*-
# stub: bigcommerce_api 0.4.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2014-02-06"
  s.description = "Enables Ruby applications to communicate with the BigCommerce API V2, using a more Ruby-like object/model syntax. Works with new Oauth authentication scheme as well as the legacy one."
